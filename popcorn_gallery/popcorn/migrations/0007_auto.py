...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('popcorn_template_categories', (
            ...
            ('templatecategory', models.ForeignKey(orm['popcorn.templatecategory'], null=False))
        ))
        db.create_unique('popcorn_template_categories', ['template_id', 'templatecategory_id'])
        ...
        db.create_table('popcorn_project_categories', (
            ...
            ('projectcategory', models.ForeignKey(orm['popcorn.projectcategory'], null=False))
        ))
        db.create_unique('popcorn_project_categories', ['project_id', 'projectcategory_id'])

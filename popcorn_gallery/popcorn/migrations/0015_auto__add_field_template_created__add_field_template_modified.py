...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.created'
        db.add_column('popcorn_template', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Template.modified'
        db.add_column('popcorn_template', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.created'
        db.delete_column('popcorn_template', 'created')

        # Deleting field 'Template.modified'
        db.delete_column('popcorn_template', 'modified')

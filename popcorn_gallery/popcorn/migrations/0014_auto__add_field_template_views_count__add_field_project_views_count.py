...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.views_count'
        db.add_column('popcorn_template', 'views_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.views_count'
        db.add_column('popcorn_project', 'views_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.views_count'
        db.delete_column('popcorn_template', 'views_count')

        # Deleting field 'Project.views_count'
        db.delete_column('popcorn_project', 'views_count')

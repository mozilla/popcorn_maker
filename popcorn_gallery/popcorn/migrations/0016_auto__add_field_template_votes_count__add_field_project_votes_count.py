...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.votes_count'
        db.add_column('popcorn_template', 'votes_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.votes_count'
        db.add_column('popcorn_project', 'votes_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.votes_count'
        db.delete_column('popcorn_template', 'votes_count')

        # Deleting field 'Project.votes_count'
        db.delete_column('popcorn_project', 'votes_count')

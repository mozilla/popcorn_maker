...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('popcorn_project', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['popcorn.Project'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.source'
        db.delete_column('popcorn_project', 'source_id')

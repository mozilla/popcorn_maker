...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('popcorn_projectcategory', (
        ...
        db.send_create_signal('popcorn', ['ProjectCategory'])

        # Adding model 'TemplateCategory'
        db.create_table('popcorn_templatecategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='name', overwrite=False)),
            ('is_featured', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('popcorn', ['TemplateCategory'])


    def backwards(self, orm):
        # Deleting model 'ProjectCategory'
        db.delete_table('popcorn_projectcategory')

        # Deleting model 'TemplateCategory'
        db.delete_table('popcorn_templatecategory')

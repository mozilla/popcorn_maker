...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.template_content'
        db.add_column('popcorn_template', 'template_content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.template_content'
        db.delete_column('popcorn_template', 'template_content')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectCategoryMembership.created'
        db.add_column('popcorn_projectcategorymembership', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'ProjectCategoryMembership.modified'
        db.add_column('popcorn_projectcategorymembership', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectCategoryMembership.created'
        db.delete_column('popcorn_projectcategorymembership', 'created')

        # Deleting field 'ProjectCategoryMembership.modified'
        db.delete_column('popcorn_projectcategorymembership', 'modified')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectCategoryMembership'
        db.create_table('popcorn_projectcategorymembership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
            ('project_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['popcorn.ProjectCategory'])),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('popcorn', ['ProjectCategoryMembership'])

        # Adding unique constraint on 'ProjectCategoryMembership', fields ['user', 'project_category']
        db.create_unique('popcorn_projectcategorymembership', ['user_id', 'project_category_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectCategoryMembership', fields ['user', 'project_category']
        db.delete_unique('popcorn_projectcategorymembership', ['user_id', 'project_category_id'])

        # Deleting model 'ProjectCategoryMembership'
        db.delete_table('popcorn_projectcategorymembership')
    ...
    models = {
        ...
        'users.profile': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['popcorn.ProjectCategoryMembership']", 'symmetrical': 'False'}),

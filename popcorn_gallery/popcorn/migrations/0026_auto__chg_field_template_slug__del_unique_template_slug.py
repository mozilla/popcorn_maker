...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Template', fields ['slug']
        db.delete_unique('popcorn_template', ['slug'])


        # Changing field 'Template.slug'
        db.alter_column('popcorn_template', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', populate_from='name', overwrite=False))

    def backwards(self, orm):

        # Changing field 'Template.slug'
        db.alter_column('popcorn_template', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
        # Adding unique constraint on 'Template', fields ['slug']
        db.create_unique('popcorn_template', ['slug'])
